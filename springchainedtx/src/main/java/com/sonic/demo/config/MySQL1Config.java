...
//        myBatisConfig.setJdbcTypeForNull(JdbcType.NULL); // Oracle
    ...
    public PlatformTransactionManager chainedTransactionManager(
            @Qualifier("mysqlTransactionManager") DataSourceTransactionManager dataSourceTransactionManager,
            @Qualifier("jmsTransactionManager") JmsTransactionManager jmsTransactionManager) {
        ChainedTransactionManager chainedTransactionManager = new ChainedTransactionManager(jmsTransactionManager, dataSourceTransactionManager);
